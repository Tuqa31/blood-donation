...
insert into users(user_mobile,user_email,user_password)
values("5050505050","user@gmail.com","Abcd370@");
...
values("admin","varunsardana004",123);
...
("A","a@gmail.com","5050505050","I need O+ Blood.");
